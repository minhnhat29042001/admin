...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/1.png")), "Admin Management", "Student", "Register", "Course", "Teacher", "Chapter", "Coursestarrate","Multiplechoice","Video","Whatwelearn","Category","Log out"));
          addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/shutdown.png")), "Log Out"));
    }
